...
public class Tester {
    ...
    public Command prematch() {
        return sequence(
                ...
                m_machinery.m_intakeExtend.stopOnce(),
                announce("CONVEYOR RUN"),
                m_machinery.m_conveyor.convey().withTimeout(1),
                m_machinery.m_conveyor.stopOnce(),
                announce("FEEDER RUN"),
                m_machinery.m_feeder.normal().withTimeout(1),
                m_machinery.m_feeder.stopOnce(),
                announce("HOOD OUT"),
                m_machinery.m_shooterHood.out().withTimeout(1),
                m_machinery.m_shooterHood.stopOnce(),
                announce("HOOD IN"),
                m_machinery.m_shooterHood.in().withTimeout(1),
                m_machinery.m_shooterHood.stopOnce(),
